...
export const TEMPLATES: Template[] = [
  {
    ...
    types: [
      ...
      { id: 'issue',     label: '议题', color: '#D97706', bg: '#FFFBEB' },
      { id: 'task',      label: '任务', color: '#059669', bg: '#ECFDF5' },
  ...
  },
  {
    ...
    rootType: 'dimension',
    types: [
      { id: 'ideal',      label: '理想化状态', color: '#E11D48', bg: '#FFF1F2' },
      { id: 'midgoal',    label: '中短期目标', color: '#7C3AED', bg: '#F5F3FF' },
      { id: 'user',       label: '目标用户',   color: '#0284C7', bg: '#F0F9FF' },
      { id: 'value',      label: '核心价值',   color: '#D97706', bg: '#FFFBEB' },
      { id: 'monthly',    label: '月度计划',   color: '#059669', bg: '#ECFDF5' },
      { id: 'affair',     label: '事务',       color: '#64748B', bg: '#F8FAFC' },
